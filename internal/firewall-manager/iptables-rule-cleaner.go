...
type IPTablesRuleCleaner[T IPTablesRule] struct {
...
func NewIPTablesRuleCleaner[T IPTablesRule](ipt iptables.IPTables) *IPTablesRuleCleaner[T] {
	return &IPTablesRuleCleaner[T]{
		ipt: ipt,
	}
}

func (c *IPTablesRuleCleaner[T]) Clean() error {
