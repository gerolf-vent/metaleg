...
func createMockIPTablesManager(nodeName string) (*IPTablesManager, *mockIPTablesForManager, *mockIPTablesForManager, *mockIPSetForManager) {
...
func TestNewIPTablesManager(t *testing.T) {
	t.Run("creates manager with valid parameters", func(t *testing.T) {
		...
		manager, err := NewIPTablesManager("test-node", 0x00F00000, excludeDstCIDRs)
...
func TestIPTablesManager_Setup(t *testing.T) {
...
func TestIPTablesManager_Cleanup(t *testing.T) {
...
func TestIPTablesManager_ReconcileEgressRule(t *testing.T) {
...
func TestIPTablesManager_CleanupStaleEgressRules(t *testing.T) {
	t.Run("handles empty rules map", func(t *testing.T) {
		iptm, _, _, _ := createMockIPTablesManager("test-node")
		
		err := iptm.CleanupStaleEgressRules(map[string]*EgressRule{})
...
func TestIPTablesManager_RuleCreationAndDeletion(t *testing.T) {
...
func TestIPTablesManager_SpecificRuleTypes(t *testing.T) {
...
func TestIPTablesManager_Integration(t *testing.T) {
...
func TestIPTablesManager_RuleSynchronization(t *testing.T) {
...
func TestIPTablesManager_CleanupOperations(t *testing.T) {
