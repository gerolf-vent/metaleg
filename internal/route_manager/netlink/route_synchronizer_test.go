...
func TestNewRouteSynchronizer(t *testing.T) {
	synchronizer := NewRouteSynchronizer()
	if synchronizer == nil {
		t.Errorf("Expected non-nil synchronizer")
	}
}

func TestRouteSynchronizer_Sync_Unit(t *testing.T) {
	testTable := 10000
...
func TestRouteSynchronizer_Sync_Integration(t *testing.T) {
...
func TestRouteSynchronizer_Sync_InvalidRoute(t *testing.T) {
	requireNetlinkWritePrivileges(t)
