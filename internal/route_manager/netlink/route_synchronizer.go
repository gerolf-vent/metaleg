...
// RouteSynchronizer synchronizes netlink routes using the state synchronizer pattern
...
func NewRouteSynchronizer() *RouteSynchronizer {
	return &RouteSynchronizer{}
}

func (s *RouteSynchronizer) Sync() error {
