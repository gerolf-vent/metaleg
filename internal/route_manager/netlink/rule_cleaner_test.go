...
func TestRuleCleaner_Clean_Unit(t *testing.T) {
...
func TestRuleCleaner_Clean_Integration(t *testing.T) {
...
func TestRuleCleaner_Clean_EmptyExpectedTables(t *testing.T) {
	requireNetlinkWritePrivileges(t)
