...
func createTestCleaner(mockIPT iptables.IPTables) *RuleCleaner[*TestCleanerRule] {
	cleaner := NewRuleCleaner[*TestCleanerRule](mockIPT)
...
func TestNewRuleCleaner(t *testing.T) {
...
func TestRuleCleaner_Clean(t *testing.T) {
...
func TestRuleCleaner_RealWorldScenario(t *testing.T) {
