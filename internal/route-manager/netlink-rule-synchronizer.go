...
// NetlinkRuleSynchronizer synchronizes netlink rules using the state synchronizer pattern
type NetlinkRuleSynchronizer struct {
...
func NewNetlinkRuleSynchronizer() *NetlinkRuleSynchronizer {
	return &NetlinkRuleSynchronizer{}
}

func (s *NetlinkRuleSynchronizer) Sync() error {
